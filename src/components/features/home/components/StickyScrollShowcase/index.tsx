...
const showcaseItems: ShowcaseItem[] = [
    {
        ...
        gradient: 'from-[#6c26f9] to-[#d507fa]',
    },
    {
        id: 'design',
        title: 'Diseño',
        ...
        gradient: 'from-[#d507fa] to-[#0586fd]',
    },
    {
        id: 'code',
        title: 'Desarrollo',
        ...
        gradient: 'from-[#0586fd] to-[#6c26f9]',
    },
    {
        id: 'launch',
        title: 'Lanzamiento',
        ...
        gradient: 'from-[#6c26f9] via-[#d507fa] to-[#0586fd]',
    },
];
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none">
                <motion.div
                    className="absolute top-4 left-4 w-20 h-20 rounded-full bg-gradient-to-r from-[#6c26f9]/20 to-transparent blur-xl"
                    animate={{ scale: [1, 1.2, 1], opacity: [0.5, 0.8, 0.5] }}
                    transition={{ duration: 4, repeat: Infinity }}
                />
                <motion.div
                    className="absolute bottom-4 right-4 w-32 h-32 rounded-full bg-gradient-to-r from-[#0586fd]/20 to-transparent blur-xl"
...
function ProgressDot({
    ...
    return (
        <motion.div
            className="w-3 h-3 rounded-full bg-gradient-to-r from-[#6c26f9] to-[#d507fa]"
            style={{ scale, opacity }}
        />
    );
}
